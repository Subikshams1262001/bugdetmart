...
id=f.getvalue("id")
sid=f.getvalue("sid")
q="""select * from shopowner_reg  where accept='New'"""
cur.execute(q)
r=cur.fetchall()
cnt=0

if sid!=None:
    q1="""update shopowner_reg set accept='accepted' where id=%s"""%(sid)
    cur.execute(q1)
    conn.commit()
    print(""""
           <script>
           alert("supermarket added");
           location.href="new_supermarket.py";
           </script>
         """)
print("""
<html>
...
<li class="nav-item">
<a class="nav-link collapsed text-truncate" style="width:200px;" href="#submenu1" data-toggle="collapse" data-target="#submenu1">
...
<h2 style="font-size:25;font-family:times new roman"><b>NEW REQUEST</b></h2>
...
for i in r:
    ...
    <td> <a href="new_supermarket.py?sid=%s">Accept</a></td></tr>
    """%(cnt,i[1],i[2],i[5],i[6],i[7],i[8],i[9],i[10],i[0]))
print("""
</table>
</div>
</div>
