		...
		<div class="card" style="height:350px">
			...
			<div class="card-footer" >
              <div class="d-flex justify-content-center links">
					Don't have an account?<a href="shopowner_reg.py">Create new account</a>
				</div>
				<div class="d-flex justify-content-center">
					<a href="shopowner_forgot_pwd.py">Forgot your password?</a>
				</div>
			</div>
		</div>
	</div>
...
if v != None:
    ...
    q = """select id from shopowner_reg where uname='%s' and pwd='%s'""" % (usr, psw)
    cur.execute(q)
    r = cur.fetchone()
    if r != None:
        print("""
                    ...
                    location.href="shopowner_dashboard.py?id=%s";
                    </script>
                """ % (r[0]))
    else:
        print("""
