...
cur=conn.cursor()
q1="""select max(id) from shopowner_reg"""
cur.execute(q1)
r=cur.fetchone()
if r[0]!=None:
    n=r[0]
...
if n<10:
    ...
    z=""
shopid="shopowner"+z+str(n+1)
print("""
<html>  
<head>   
<title>Shopowner registration</title>
...
<tr>
<td align="left"><b>Shop ID:</b></td>
<td><input type="text" name="shopid" id="shopid" value="%s" readonly autocomplete="off"></td>
</tr>
<tr>
...
<tr>
<td align="left"><b><br>Username:</b></td>"""%(shopid))
print("""
...
<a href="shopowner_login.py"><u><b>Existing user? Click to Login</b></u></a>
</div> 
</center>
</body>  
</html>  
...
if sub != None:
    ...
    if profile.filename:
        ...
        q="""insert into
        shopowner_reg(shopid,name,dates,gm,uname,pwd,gmail,number,address,profile,accept)
        values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"""%(shopownerid,name,dob,gender,uname,pwd,email,mobno,address,fp,"New")
        cur.execute(q)
        conn.commit()
        conn.close()
        ...
        print("""
                            ...
                            location.href="shopowner_login.py";
                            </script>
                           """)
    else:
        print("""
                            <script>
                            alert("Login invalid");
                            location.href="shopowner_reg.py";
                            </script>
                            """)